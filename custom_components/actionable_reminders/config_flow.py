...
class ActionableRemindersConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def _create_hub(self) -> FlowResult:
        ...
        hub_data = {
            ...
            CONF_DEFAULT_RESPONSE_WINDOW: DEFAULT_RESPONSE_WINDOW,
            CONF_DEFAULT_NAG_MIN_GAP: DEFAULT_NAG_MIN_GAP,
            CONF_DEFAULT_NAG_MAX_GAP: DEFAULT_NAG_MAX_GAP,
            CONF_DEFAULT_NAG_FRACTION: DEFAULT_NAG_FRACTION,
            ...
            CONF_CLEAR_NOTIFICATION_SERVICE: None,
            CONF_DEFAULT_ALEXA_DEVICES: [],
            CONF_DEFAULT_PRESENCE_SENSORS: [],
            CONF_VOICE_RESPONDERS: "",
        }
